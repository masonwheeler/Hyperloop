...
MIN_SPEED = MAX_SPEED / 1.25

MAX_LATERAL_CURVATURE = MAX_LATERAL_ACCEL / MIN_SPEED**2 #Meters^{-1}
MAX_LONGITUDINAL_CURVATURE = MAX_LONGITUDINAL_ACCEL / MIN_SPEED**2 #Meters^{-1}
MAX_VERTICAL_CURVATURE = MAX_VERTICAL_ACCEL / MIN_SPEED**2 #Meters^{-1}
